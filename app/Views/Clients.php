...
<body class="body3">
    ...
    <br><br><br><br><br>
		<div class="jumbotron">
			<h1 class="display-4">CLIENTS SESSION</h1>
			...
			<div class="row">
				<div class="col-12 col-md-12">
					<div class="card text-white bg-dark mb-3" style="max-width: 67rem;">
						...
						<div class="card-body">
						  <form  class="mt-5 pb-5" action="<?php echo(base_url('public/Clients/Add'))?>" method="POST">
                               <div class="form-row">
                                ...
                                <button type="submit" id="envio" name="envio" class="btn btn-outline-light">REGISTER</button>
                                <h3 class="text-center"><?php echo(session("Su peticion ha sido enviada, Ya eres cliente"))?></h3>
						  </form >
						</div>
					</div>
				</div>
